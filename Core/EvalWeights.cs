...
namespace MegaKnight.Core
{
    internal static class EvalWeights
    {
        ...
        public static readonly int[] PawnPSTLate = new int[]
        {
              0,   0,   0,   0,   0,   0,   0,   0,
        ...
        public static readonly int[] KnightPSTEarly = new int[]
        {
        ...
        public static readonly int[] KnightPSTLate = new int[]
        {
        ...
        public static readonly int[] BishopPSTEarly = new int[]
        {
        ...
        public static readonly int[] BishopPSTLate = new int[]
        {
        ...
        public static readonly int[] RookPSTEarly = new int[]
        {
        ...
        public static readonly int[] RookPSTLate = new int[]
        {
        ...
        public static readonly int[] QueenPSTEarly = new int[]
        {
        ...
        public static readonly int[] QueenPSTLate = new int[]
        {
        ...
        public static readonly int[] KingPSTEarly = new int[]
        {
        ...
        public static readonly int[] KingPSTLate = new int[]
        {
